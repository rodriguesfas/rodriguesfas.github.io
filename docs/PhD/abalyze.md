...
Quais Coletas de Dados podem ser Realizadas?

Com o ABALyze para atividades adaptadas para dificuldades de aprendizagem, pode-se coletar uma variedade de dados relacionados ao desempenho e ao progresso dos usuários. Aqui estão alguns exemplos de dados que podem ser coletados:
...
Quais Análises Podem Ser Realizadas Com Os Dados Coletados?
