...
Competências: Python, PHP, JavaScritp, MySQL, TinyDB, Codeigniter, Ratchet, Socket.IO, Clarity, Sentry, FastAPI, Flask, Docker, AWS (Serveless, Container Registry, Lambda, API Gateway, S3 Bucket), Bootstrap, HTML, CSS.
...
Competências: Machine Learning, Python, PLN, FastAPI, AWS, Azure, Docker, SQLAlchemy.
